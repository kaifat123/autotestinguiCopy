...
Check console output at ${BUILD_URL} to view the results.''',
        ...
        stage("BackUp job"){
            steps{
                sh "C:\\Windows\\System32\\config\\systemprofile\\AppData\\Local\\Jenkins\\.jenkins\\jenkins-backup-script-master\\jenkins-backup.sh C:\\Windows\\System32\\config\\systemprofile\\AppData\\Local\\Jenkins\\jenkins_backup archive.tar.gz"
            }
        }
    }
}
